...
class Fusion(nn.Module):
    ...
    def __init__(self, n_layers=4, specialized_layers=3, filters=64):
        ...
        for i in range(n_layers)[::-1]:
            ...
            convs = nn.ModuleList([
                utils.Conv2d(in_channels, num_filters, size=2, activation=None),
                utils.Conv2d(in_channels + (increase or num_filters), num_filters, size=3),
                utils.Conv2d(num_filters, num_filters, size=3)]
            )
